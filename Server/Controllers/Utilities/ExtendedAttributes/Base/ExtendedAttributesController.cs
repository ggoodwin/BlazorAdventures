...
using Application.Features.ExtendedAttributes.Commands.Delete;
...
using Application.Features.ExtendedAttributes.Commands.Queries.GetById;
using Domain.Contracts;
using Microsoft.AspNetCore.Mvc;

namespace Server.Controllers.Utilities.ExtendedAttributes.Base
{
    /// <summary>
