...
{
    public abstract class AuditableContext : IdentityDbContext<BlazorAdventuresUser, BlazorAdventuresRole, string, IdentityUserClaim<string>, IdentityUserRole<string>, IdentityUserLogin<string>, BlazorAdventuresRoleClaim, IdentityUserToken<string>>
    {
