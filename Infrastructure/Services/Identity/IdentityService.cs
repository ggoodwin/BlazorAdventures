...
namespace Infrastructure.Services.Identity
{
    public class IdentityService : ITokenService
    {
        ...
        private readonly SignInManager<BlazorAdventuresUser> _signInManager;

        public IdentityService(
            UserManager<BlazorAdventuresUser> userManager, RoleManager<BlazorAdventuresRole> roleManager,
            IOptions<AppConfiguration> appConfig, SignInManager<BlazorAdventuresUser> signInManager)
        {
        ...
        private async Task<string> GenerateJwtAsync(BlazorAdventuresUser user)
        {
            var token = GenerateEncryptedToken(GetSigningCredentials(), await GetClaimsAsync(user));
            return token;
        }

        private async Task<IEnumerable<Claim>> GetClaimsAsync(BlazorAdventuresUser user)
        {
