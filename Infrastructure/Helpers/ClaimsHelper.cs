...
namespace Infrastructure.Helpers
{
    public static class ClaimsHelper
    {
        ...
        public static async Task<IdentityResult> AddPermissionClaim(this RoleManager<BlazorAdventuresRole> roleManager, BlazorAdventuresRole role, string permission)
        {
