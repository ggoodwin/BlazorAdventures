...
namespace Shared.Constants.Permission
{
    public static class Permissions
    {
        ...
        [DisplayName("Stamps")]
        [Description("Stamps Permissions")]
        public static class Stamps
        {
            public const string View = "Permissions.Stamps.View";
            public const string Create = "Permissions.Stamps.Create";
            public const string Edit = "Permissions.Stamps.Edit";
            public const string Delete = "Permissions.Stamps.Delete";
            public const string Export = "Permissions.Stamps.Export";
            public const string Search = "Permissions.Stamps.Search";
            public const string Import = "Permissions.Stamps.Import";
        }
