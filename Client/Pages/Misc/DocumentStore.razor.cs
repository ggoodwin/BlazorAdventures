...
using Client.Infrastructure.Managers.Misc.Document;
    ...
    public partial class DocumentStore
    {
        ...
        private async Task LoadData(int pageNumber, int pageSize, TableState state)
        {
            ...
            if (response.Succeeded)
            {
                ...
                //{
                //    item.URL = $"{_config["Urls:Api"]}/{item.URL}";
                //}
                _pagedData = data;
            }
            else
        ...
        private async Task InvokeModal(int id = 0)
        {
            ...
            var dialog = _dialogService.Show<AddEditDocumentModal>(id == 0 ? "Create" : "Edit", parameters, options);
